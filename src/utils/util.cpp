...
#include "treasurelandcoin/treasurelandcoin.h"                                              // MCHN
...
/* MCHN START */
static boost::filesystem::path pathCachedTreasureLandCoin;
...
/* MCHN START */
    ...
    pathCachedTreasureLandCoin=fs::path(string(mc_gState->m_Params->DataDir()));
    fs::path &path =pathCachedTreasureLandCoin;
    return path;
...
/* MCHN START */
    ...
    return pathCachedTreasureLandCoin;
//    pathCachedTreasureLandCoin=fs::path(string(mc_gState->m_Params->DataDir()));
//    fs::path &path =pathCachedTreasureLandCoin;
//    return path;
//    fs::path &path = fNetSpecific ? pathCachedNetSpecific : pathCached;
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "treasurelandcoin.pid"));
