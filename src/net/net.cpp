...
/* MCHN START */
    ...
    {
        subver=FormatSubVersion("TreasureLandCoin", mc_gState->GetProtocolVersion(), std::vector<string>());
    }
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TreasureLandCoin " + FormatFullVersion();
...
bool BindListenPort(const CService &addrBind, string& strError, bool fWhitelisted)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TreasureLandCoin Core is probably already running."), addrBind.ToString());
        else
