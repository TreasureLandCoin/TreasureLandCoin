...
Value prioritisetransaction(const Array& params, bool fHelp)
{
    ...
    throw JSONRPCError(RPC_NOT_SUPPORTED, "Transaction prioritization is not supported in this version of TreasureLandCoin");        
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    throw JSONRPCError(RPC_NOT_SUPPORTED, "getblocktemplate is not supported in this version of TreasureLandCoin");        
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "TreasureLandCoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "TreasureLandCoin is downloading blocks...");
