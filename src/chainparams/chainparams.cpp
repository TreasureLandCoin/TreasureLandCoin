...
/* MCHN START */
static Checkpoints::MapCheckpoints mapCheckpointsTreasurelandcoin =
        boost::assign::map_list_of
        ( -1, uint256("0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"))
        ;
static const Checkpoints::CCheckpointData dataTreasurelandcoin = {
        &mapCheckpointsTreasurelandcoin,
        0,
        0,
        0
    };
...
class CTreasureLandCoinParams : public CMainParams {
public:
    CTreasureLandCoinParams() {    };
    
    void SetFixedParams(const char *NetworkName)
    {
        networkID = CBaseChainParams::TREASURELANDCOIN;
...
//        convertSeed6(vFixedSeeds, pnSeed6_test, ARRAYLEN(pnSeed6_test));
        ...
        SetTreasureLandCoinRuntimeParams();
    ...
    void SetTreasureLandCoinRuntimeParams()
    {
...
//        assert(hashGenesisBlock == uint256("0x0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"));
    ...
    const Checkpoints::CCheckpointData& Checkpoints() const 
    {
        return dataTreasurelandcoin;
    }
};
static CTreasureLandCoinParams treasurelandcoinParams;


bool SelectTreasureLandCoinParams(const char *NetworkName)
{
    SelectTreasureLandCoinBaseParams(NetworkName,(int)mc_gState->m_NetworkParams->GetInt64Param("defaultrpcport"));

    treasurelandcoinParams.SetFixedParams(NetworkName);
    
    treasurelandcoinParams.Initialize();
    
    pCurrentParams = &treasurelandcoinParams;
...
void SetTreasureLandCoinRuntimeParams()
{
    treasurelandcoinParams.SetTreasureLandCoinRuntimeParams();
}

bool InitializeTreasureLandCoinParams()
{
    
    treasurelandcoinParams.Initialize();
    
    treasurelandcoinParams.SetGenesis();
