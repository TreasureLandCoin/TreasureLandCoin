...
#ifndef TREASURELANDCOIN_STATE_H
#define	TREASURELANDCOIN_STATE_H

#include "utils/define.h"
#include "chainparams/params.h"
#include "protocol/treasurelandcoinscript.h"
...
{    
    ...
    mc_Params               *m_Params;
    mc_TreasurelandcoinParams     *m_NetworkParams;
    ...
    void  InitDefaults()
    {
        ...
        m_NetworkParams=new mc_TreasurelandcoinParams;
        m_Permissions=NULL;
        m_Assets=NULL;
...
#endif	/* TREASURELANDCOIN_STATE_H */
